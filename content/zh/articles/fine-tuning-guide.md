...
### Q1: 全参数微调与 LoRA 应该如何选择？

通常情况下，推荐使用 LoRA 进行微调，它能在保留基础模型能力的同时显著降低计算资源需求。如果显存极度受限，可结合 [大模型量化实战指南](/articles/quantization-hands-on-guide/) 采用 QLoRA。

### Q2: 微调数据需要多少条？

高质量的数据比数量更重要，一般准备 200-500 条高质量数据即可获得不错的效果，过多低质数据反而会导致灾难性遗忘。
